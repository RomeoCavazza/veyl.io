...
export default function Community() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // EmailJS configuration - À configurer avec vos clés EmailJS
      // Créer un compte sur https://www.emailjs.com et configurer les clés
      await emailjs.send(
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4 items-start">
              <a href="https://www.iscom.fr/formation/bac-4-planning-strategique-marketing-innovation" target="_blank" rel="noopener noreferrer">
                <img src="https://img.shields.io/badge/ISCOM-116e9d?style=flat&logoColor=white" alt="ISCOM" className="h-5 flex-shrink-0" style={{ marginTop: '2px' }} />
              </a>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4 items-start">
              <a href="https://www.epitech.eu/formation-alternance/pre-msc-post-bac2/" target="_blank" rel="noopener noreferrer">
                <img src="https://img.shields.io/badge/EPITECH-2693d0?style=flat&logoColor=white" alt="EPITECH" className="h-5 flex-shrink-0" style={{ marginTop: '2px' }} />
              </a>
              <div className="space-y-4 flex-1">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4 items-start">
              <a href="https://github.com/RomeoCavazza/veyl.io" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5 text-muted-foreground hover:text-primary transition-colors flex-shrink-0" style={{ marginTop: '2px' }} viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                </svg>
              </a>
              <div className="space-y-4 flex-1">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4 items-start">
              <a href="https://discord.gg/TKbNuuV4sX" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="h-5 w-5 text-muted-foreground hover:text-primary transition-colors flex-shrink-0" style={{ marginTop: '2px' }} fill="currentColor">
