            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-4 flex-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Conceived and inspired at <strong>ISCOM Paris</strong>, this project emerged from strategic planning expertise in influence agencies. Designed for business insights, niche auditing, and real-time social media intelligence <span className="text-xs">to analyze consumer behaviors and cultural trends.</span>
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-4 flex-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Technical development made possible thanks to <strong>EPITECH Paris</strong> education. Built with modern stack including FastAPI, React, PostgreSQL, and real-time APIs integration <span className="text-xs">for scalable social intelligence platform architecture.</span>
                </p>
                <div className="flex items-center gap-2 pt-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-4 flex-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Fully <strong>open source</strong> and available on GitHub. Committed to staying open source forever. Contribute via Pull Requests, report issues, or suggest features <span className="text-xs">to shape the future of social intelligence.</span>
                </p>
                <div className="flex items-center gap-2 pt-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-4 flex-1">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Join our Discord server to exchange with the community and contribute to the project. Connect with EPITECH and ISCOM Paris students, partner agencies, and beta testers <span className="text-xs">to shape the future of social intelligence together.</span>
                </p>
                <div className="flex items-center gap-2 pt-2">
