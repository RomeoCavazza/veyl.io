  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-12 px-4 max-w-6xl">
        ...
        <section className="mb-20">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            {/* Illustration (50%) - Bouton GitHub stylisé */}
            <div className="w-full flex justify-center">
              <a 
                href="https://github.com/RomeoCavazza/veyl.io" 
                target="_blank" 
                rel="noopener noreferrer"
                className="group relative p-4 rounded-2xl backdrop-blur-xl border-2 border-primary/30 bg-gradient-to-br from-primary/40 via-black/60 to-black/80 shadow-2xl hover:shadow-primary/30 hover:shadow-2xl hover:scale-[1.02] hover:-translate-y-1 active:scale-95 transition-all duration-500 ease-out cursor-pointer hover:border-primary/60 overflow-hidden block"
              >
                ...
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-primary/10 via-primary/20 to-primary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                
                <div className="relative z-10 flex items-center gap-4">
                  <div className="p-3 rounded-lg bg-gradient-to-br from-primary/30 to-primary/10 backdrop-blur-sm group-hover:from-primary/40 group-hover:to-primary/20 transition-all duration-300">
                    <Github className="w-7 h-7 text-primary group-hover:text-primary/90 transition-all duration-300 group-hover:scale-110 drop-shadow-lg" />
                  </div>
                  
                  <div className="flex-1 text-left">
                    <p className="text-primary font-bold text-lg group-hover:text-primary/90 transition-colors duration-300 drop-shadow-sm">
                      GitHub
                    </p>
                    <p className="text-primary/60 text-sm group-hover:text-primary/80 transition-colors duration-300">
                      Voir le repository
                    </p>
                  </div>
